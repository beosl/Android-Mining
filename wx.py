		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					pwv.append('963963963')
					pwv.append('poiupoiu')
					pwv.append('qqwweerr')
					pwv.append('qqwweerrttyy')
					pwv.append('qwert12345')
					pwv.append('20202020')
					pwv.append('20062006')
					pwv.append('aassdd')
					pwv.append('aassdd@@@')
					...
					pwv.append('zxcvbnmzxcvbnm')
					pwv.append('zxcvbnm1234')
					pwv.append('zxcvbnm12345')
					pwv.append('zzxxccvv')
					pwv.append('zzxxccvvbb')
					pwv.append('zzxxccvvbbnn')
					pwv.append('zzxxccvvbbnnmm')
					pwv.append('qqww1212')
					pwv.append('qq1w2e3r4t5y6u7')
					pwv.append('zxcvbnmlpoiuytrewqasdfghjkl')
					pwv.append('qqwweeqq')
