...
: :  / `             :__.'
 ...
 :             .'
  \ )       .-'
   ...
   ===============================================================
\033[1;36m
  _______ ______ _____  __  __  ______   __
 |__   __|  ____|  __ \|  \/  |/ __ \ \ / /
    | |  | |__  | |__) | \  / | |  | \ V / 
    | |  |  __| |  _  /| |\/| | |  | |> <  
    | |  | |____| | \ \| |  | | |__| / . \ 
...
\033[1;36m[-] AUTHOR    :\033[1;36m BATA
\033[1;36m[-] NRXI TOOL :\033[1;30m 10$
\033[1;36m[-] TOOLS      :\033[1;32m TOOLS IN MONY
\033[1;36m[-] VERSION   :\033[1;34m V.7
\033[1;36m[-] STATUS    :\033[1;35m  BATAm709 
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;98mCRACK FILE [1]')
	print('')
	print(' [1]BEST')
	print('')
	_IPYTHONI_(f'\x1b[1;98mCRACK ID PUBLICK [2]')
	_____IPYTHONI_____ = input('\x1b[1;96mCHOSSE = \x1b[1;97m ')
...
class D:
	...
	def plerr(self):
		...
		try:
			print(' Download file')
			print(' /sdcrad/Download/Telegram/namefile.txt')
			print('')
			print(' dlm file dane la xwarawa👇')
			print('')
			fileX = input ('\x1b[1;93ENTER FILE: ')
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\x1b[1;91mIDz : \x1b[1;97m'+str(len(id)))
			Settings()
		except IOError:
...
#SERVER-SETTING			
def Settings():
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m👉 1 👈\x1b[1;91m]\x1b[1;97\x1b[1;91m[FAST]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m👉 2 👈\x1b[1;91m]\x1b[1;97\x1b[1;93m [BEST]')
	hu = input('\x1b[1;96mCHOSSE = \x1b[1;97m')
	if hu in ['1','01']:
		muda=[]
	...
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m\x1b[1;91m]\x1b[1;97mBEST\x1b[1;95m👉 1 👈')
	hc = input('\x1b[1;96mCHOSSE = \x1b[1;97m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	pwplus=input('\x1b[1;97m\x1b[1;31m[FAST]\x1b[1;31m👉 M 👈\x1b[1;92m\x1b[1;32m[BEST]\x1b[1;32m👉 A 👈\n\x1b[1;96mCHOSSE = \x1b[1;97m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	print(f"\x1b[1;97m------------------------------------------------------------")
	print(f" TIME: \x1b[1;97m{ha}\x1b[1;97m/\x1b[1;97m{bu}\x1b[1;97m/\x1b[1;97m{ta} ")
	print(f"\x1b[1;97m------------------------------------------------------------")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}{H}{ok}{P}{P}/{M}{cp}{P} = {P}{b}{loop}{P} = {b}{len(id)}{P} = ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
